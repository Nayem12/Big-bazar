  ...
  return (
    <div className='bg-gradient-to-r from-[#686562] to-[#444553]'>
      ...
      <div className='flex justify-end mt-2 mr-2 '>
        <label htmlFor="my-drawer-2" className="btn border-emerald-700 text-red-600 btn-outline  hover:bg-emerald-700   lg:hidden">Show Menu</label>
      </div>
      ...
      <div className="drawer drawer-mobile">
        ...
        <div className="drawer-side">
          ...
          <ul className="menu   w-80 dashclo text-base-content border-r-2 border-[#03250942]  ">
